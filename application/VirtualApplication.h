...
class VirtualApplication: public CastaliaModule, public TimerService {
 protected:
	...
	myDataPacket *createMyDataPacket(double*, unsigned int, int=-1);
	//ApplicationPacket *createGenericDataPacketM(vector<double>, unsigned int, int = -1);//penambahan untuk penanganan matrix
